...
public class Image1Adapter extends BaseAdapter {
    ...
    // Constructor
    public Image1Adapter(Context c, ArrayList<Event> listData){
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.ch, null);
        ...
        ImageLoader.getInstance().displayImage(listData.get(position).getPic_cover(),holder.imageView, options, new ImageLoadingListener() {
            @Override
