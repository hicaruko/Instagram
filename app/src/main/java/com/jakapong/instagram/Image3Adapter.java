...
public class Image3Adapter extends BaseAdapter {
    ...
    private ArrayList<LeaderBoard>  listData;
    private LayoutInflater layoutInflater;
    private DisplayImageOptions options;
    // Constructor
    public Image3Adapter(Context c, ArrayList<LeaderBoard> listData){
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.list3_item, null);
        ...
        ImageLoader.getInstance().displayImage(listData.get(position).getPic_icon(),holder.imageView, options, new ImageLoadingListener() {
            @Override
